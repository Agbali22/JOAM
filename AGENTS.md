...
- Main files are `index.html`, `experience.html`, `projects.html`, `gear.html`, `gallery.html`, `map.html`, `style.css`, and `script.js`.
- Maintain the black editorial design system in `style.css`.
