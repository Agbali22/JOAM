...
if (photoMapElement) {
  ...
  const photoDescriptions = {
    "Women and the Movement":
      "A museum portrait with warm light, dark walls, and a quiet documentary feel.",
    "Boarding Pass":
      "A travel detail frame: Nikon strap, boarding pass, and the start of a trip.",
    "Blowout Portrait":
      "A personal style frame with warm indoor light and a freshly shaped blowout.",
    "Metro Card":
      "A small transit detail that turns a metro card into part of the story.",
    "Metro Overlook":
      "A wide look over the Metro platform, built around lines, shadows, and movement.",
    "Dusk Portrait":
      "A calm evening portrait with the city lights beginning to show behind the frame.",
    "Monument Frame":
      "The Washington Monument held between architecture, sky, and negative space.",
    "Underground Metro":
      "A cinematic underground platform moment with warm concrete and train light.",
    "Camera Day":
      "A camera-day portrait that feels casual, reflective, and tied to the act of making images.",
    "Freer Gallery":
      "A bright exterior frame with museum architecture, open sky, and summer light.",
    "Second Blowout Portrait":
      "A side portrait focused on shape, texture, and the quiet confidence of the moment.",
    "Yellow and Blue Plane":
      "A bold aircraft frame with museum darkness, yellow paint, and strong diagonal movement.",
    "Street Profile":
      "A California street profile with mountains, road light, and a still walking moment.",
    "Smithsonian Garden":
      "A garden and red-brick architecture frame with soft greenery and summer color.",
    "American Airlines Plane":
      "A polished aircraft museum frame with chrome, glass, and aviation history.",
    "Sidewalk Back View":
      "A back-view city walk with afternoon light, reflections, and motion through DC.",
    "Castle Towers":
      "A distant view of the Smithsonian Castle towers, framed by trees and sky.",
    "Hotel Lobby Work":
      "A quieter travel-night image, focused on working, writing, and warm interior light.",
    "DC Avenue":
      "A wide city avenue view with benches, trees, and a calm line into the distance.",
    "Alley Self Portrait":
      "A reflective alley self portrait with camera, shadow, and city texture.",
  ...
  function updateMapPreview(location) {
    ...
    mapPreviewText.textContent =
      photoDescriptions[location.title] || location.alt;
  ...
  if (window.L) {
    ...
    const markers = photoLocations.map((location) => {
      ...
      marker.on("click", () => {
        document
          .querySelectorAll(".photo-marker.is-active")
          .forEach((markerElement) => {
            markerElement.classList.remove("is-active");
          });
        marker
          .getElement()
          ?.querySelector(".photo-marker")
    ...
    photoMapElement.innerHTML =
      '<p class="map-fallback">The map library could not load. Check your internet connection and refresh.</p>';
  }
}
